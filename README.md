...
### 概要・背景
NFC技術と連携した勤怠管理アプリは多く存在しますが、スマートフォン本体やスマートウォッチと連携して打刻できる仕組みを実現したいと考え、本アプリを開発しました。  
...
### 技術選定
本アプリケーションのフロントエンドには Next.js を採用しています。  
業務でも Next.js を使用しているため、個人開発を通して理解をより深めることを目的としています。  
また、将来的に既存の自社サービスと統合できる可能性も考慮し、同じ技術スタックで開発を行っています。  
さらに、Next.js の App Router を用いたモダンな Web アプリケーション開発を実践的に学ぶことも目的としています。
